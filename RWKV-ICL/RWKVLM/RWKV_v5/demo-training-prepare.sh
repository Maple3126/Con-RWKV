...
python train.py --wandb "" --proj_dir $PROJ_DIR \
 --data_file "/home/RWKVICL/RWKVLM/data/uniform-binidx/train" --data_type "binidx" --vocab_size 2 --my_testing $MODEL_TYPE \
 --ctx_len $CTX_LEN --my_pile_stage 1 --epoch_count 1 --epoch_begin 0 \
 --epoch_save 1 --weight_decay 0 --head_size_a 64 \
 --num_nodes 1 --micro_bsz 1 --n_layer $N_LAYER --n_embd $N_EMBD --pre_ffn 0 --head_qk 0 --my_exit_tokens 100000 --magic_prime 41 \
