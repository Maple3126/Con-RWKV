...
#
DS_BUCKET_MB=2 # set to 2 for consumer GPUs, set to 200 for A100 / H100 (affects speed & vram usage)  #7/22/0926 data order 4
#
#weight_decay 0.001 #--my_exit_tokens 100000 --load_model " "
#--data_val_file "/home/RWKVICL/RWKVLM/data/markov-binidx-val/val"
python train.py --wandb "Test" --proj_dir $PROJ_DIR --my_testing $MODEL_TYPE \
 --ctx_len $CTX_LEN --my_pile_stage 3 --epoch_count 20 --epoch_begin 0 \
 --data_file "/home/RWKVICL/RWKVLM/data/markov-binidx/train" --magic_prime 41 \
 --num_nodes $N_NODE --micro_bsz $M_BSZ --n_layer $N_LAYER --n_embd $N_EMBD --pre_ffn 0 --head_qk 0 \
 --lr_init $LR_INIT --lr_final $LR_FINAL --warmup_steps 10 --beta1 0.9 --beta2 0.99 --adam_eps 1e-18 --my_pile_edecay 0 --data_type "binidx" --vocab_size 2 \
 --weight_decay 0 --epoch_save $EPOCH_SAVE --head_size_a 64 \
