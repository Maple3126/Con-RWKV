...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_val_file", default="", type=str)
    parser.add_argument("--data_file", default="", type=str)
    parser.add_argument("--data_type", default="utf-8", type=str)
    parser.add_argument("--vocab_size", default=0, type=int)  # vocab_size = 0 means auto (for char-level LM and .txt data)

    parser.add_argument("--ctx_len", default=1024, type=int)
    parser.add_argument("--epoch_steps", default=5, type=int)  # a mini "epoch" has [epoch_steps] steps  # 多少個512才算一個epoch?
...
"""
    ...
    # Data (train)  = {args.data_file} ({args.data_type})
    # Data (valid)  = {args.data_val_file} ({args.data_type})
    # ProjDir       = {args.proj_dir}  ##寫在上面換Data
    ...
    from src.dataset import MyDataset, ValDataset

    train_data = MyDataset(args)
    # args.vocab_size = train_data.vocab_size
    # val_data = ValDataset(args)  # 加 is_train 參數視你的 Dataset 類別設計
    # val_loader = DataLoader(
    # val_data, shuffle=False, pin_memory=True,
