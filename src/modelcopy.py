    ...
    if os.environ["RWKV_TRAIN_TYPE"] == 'infctx':
        ...
        def training_step(self, batch, batch_idx):
            ...
            def checkpointed_step(idx, targets, prev_loss, last_shift_states,
                ...
                # loss = loss + 0.01 * sum(b._dummy_loss for b in self.blocks if hasattr(b, "_dummy_loss"))
                ########################
        ...
        def training_step(self, batch, batch_idx):
            ...
            if args.loss_mask:
                ...
                loss = loss + args.conv_dummy_scale * dummy_loss
                # print("b") 
            # return loss       
